...
{
    m_processed_count++;
    LOG_INFO("FFMPEG", "Processing video #" + std::to_string(m_processed_count) + " record_id=" + msg.record_id + " path=" + msg.file_path);
    ...
    msg_save_vaa_blocks save_msg;
    save_msg.record_id = msg.record_id;
    save_msg.blocks = blocks;
    save_msg.request_id = msg.request_id;
    save_msg.reply_to = msg.reply_to;
